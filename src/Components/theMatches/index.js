...
import LeagueTable from '../theMatches/table';
          ...
          <div className="left">
            <div className="match_filters">
              <div className="match_filters_box">
                ...
                <div className="cont">
                  <div className={`option ${state.played === 'All' ? 'active':''}`}
                      onClick={()=> this.showPlayed('All')}
                  >
                      All
                  </div>
                  <div className={`option ${state.played === 'Yes' ? 'active':''}`}
                      onClick={()=> this.showPlayed('Yes')}
                  >
                      Played
                  </div>
                  <div className={`option ${state.played === 'No' ? 'active':''}`}
